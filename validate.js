...
(function(window, document, undefined) {
    ...
    var FormValidator = function(formName, fields, messagesObj, callback) {
        
        defaults.messages = $.extend(defaults.messages, messagesObj);
        //defaults.messages = $.extend(defaults.messages, regexObj);
    ...
    FormValidator.prototype._validateForm = function(evt) {
        ...
        if (typeof this.callback === 'function') {
            this.callback(this.errors, evt, this.fields);
        }
